...
class Header extends React.Component {
  ...
  renderStatusBar() {
    if (this.props.showStatusBar) {
      if (this.props.statusBarType === 'light') {
        return <StatusBar backgroundColor='rgba(254,189,105,1)' barStyle='dark-content' />
      } else if (this.props.statusBarType === 'dark') {
        return <StatusBar backgroundColor='rgba(74, 74, 74, 1)' barStyle='light-content' />
      }
    }
  ...
  renderNavRight() {
    ...
    } else if (this.props.navRightType === 'add') {
      icon = <TouchableOpacity onPress={() => { navigate('MemberAddRecipe') }}>
        <Icon name='plus' type='Entypo' style={theme.navRightIcon} />
      </TouchableOpacity>
    } else if (this.props.navRightType === 'menu') {
      icon = <TouchableOpacity onPress={() => { navigate('MemberPropertyAdd') }}>
