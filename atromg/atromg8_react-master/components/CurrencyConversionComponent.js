      ...
      >
        ...
        >
          <Item stackedLabel style={{ width: "43%", height: normalize(50) }}>
            <Label style={{fontSize:14}}>Enter {cryptoInput ? coinCode : fiatCode}</Label>
            <Input
              keyboardType="numeric"
              style={{ color: Colors.noticeText,paddingLeft:0 }}
              value={amount}
          ...
          />
          <Item stackedLabel style={{ width: "43%", height: normalize(50) }}>
            <Label style={{fontSize:14}}>{cryptoInput ? fiatCode : coinCode}</Label>
